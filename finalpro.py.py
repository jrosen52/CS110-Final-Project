...
class Intro:
    ...
    def __init__(self):
        ...
        while (intro == True):
            ...
            button("Start", (screenwidth/2 - button_width / 2), screenheight*(4/10), button_width, button_height, dark_green, bright_green)
            button("Quit", (screenwidth/2 - button_width / 2), screenheight*(6/10), button_width, button_height, dark_red, bright_red)
            button("High Scores", (screenwidth/2 - button_width / 2), screenheight*(8/10), button_width, button_height, dark_blue, bright_blue)
...
class High:
    def __init__(self):
        ...
        while (high == True):
            ...
            button("back", (screenwidth/2 - button_width / 2), screenheight*(8/10), button_width, button_height, dark_blue, bright_blue)
